function isMobileBrowser () {
  const regAstring = `/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry
    ...
    browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook
    |silk`.replace(/\s/g, '');
  const regA = new RegExp(regAstring, 'i');
  const regBstring = `/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa
    ...
    |kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w
    |m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)
    |mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa
    |n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on
    ...
    |zte\-`.replace(/\s/g, '');
  const regB = new RegExp(regBstring, 'i');
  let check = false;
  (function (a) {
    if (regA.test(a) || regB.test(a.substr(0, 4))) {
      check = true;
    }
